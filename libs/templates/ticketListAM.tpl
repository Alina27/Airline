	...
	<div class = mainPanel>
		...
		<hr id = "seventh">	
		  ...
		  <label id = "passInf"> Person whow attent in departure airport</label>
			...
			<h3 id = "ticketFN">{$tktFullNameDepAM}</h3>
			<h4 id = "ticketDB">{$tktPhoneDepAM}</h4>
		<hr id = "seventh">
			
	<label id = "passInf"> Person whow attent in arriving airport </label>
			<h3 id = "ticketFN">{$tktFullNameArrAM}</h3>
			<h4 id = "ticketDB">{$tktPhoneArrAM}</h4>
			<!-- <h4 id = "ticketLugg">Baggage <span id = "luggAmount">2</span></h4> 
			<h4 id = "ticketSeats">5A</h4>-->
		
	  <hr id = "seventh">		
			<label id = "passInf"> Total Price: <span id = "totPrs">{$totPrs}</span> <span></span></span> </label>
